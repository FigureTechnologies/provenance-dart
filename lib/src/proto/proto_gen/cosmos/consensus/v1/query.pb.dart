...
class QueryParamsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.consensus.v1'),
      createEmptyInstance: create)
    ..aOM<$1.ConsensusParams>(1, _omitFieldNames ? '' : 'params',
  ...
  @$pb.TagNumber(1)
  $1.ConsensusParams get params => $_getN(0);
  @$pb.TagNumber(1)
  set params($1.ConsensusParams v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $1.ConsensusParams ensureParams() => $_ensure(0);
}
