...
class Config extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<GolangBinding>(
        2, _omitFieldNames ? '' : 'golangBindings', $pb.PbFieldType.PM,
        subBuilder: GolangBinding.create)
...
class ModuleConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<GolangBinding>(
        3, _omitFieldNames ? '' : 'golangBindings', $pb.PbFieldType.PM,
        subBuilder: GolangBinding.create)
    ..hasRequiredFields = false;
...
class GolangBinding extends $pb.GeneratedMessage {
  ...
  factory GolangBinding.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GolangBinding.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GolangBinding',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'cosmos.app.v1alpha1'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GolangBinding copyWith(void Function(GolangBinding) updates) =>
      super.copyWith((message) => updates(message as GolangBinding))
          as GolangBinding;
  ...
  static $pb.PbList<GolangBinding> createRepeated() =>
      $pb.PbList<GolangBinding>();
  @$core.pragma('dart2js:noInline')
  static GolangBinding getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GolangBinding>(create);
  ...
  @$pb.TagNumber(1)
  set interfaceType($core.String v) {
    $_setString(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set implementation($core.String v) {
    $_setString(1, v);
  }
