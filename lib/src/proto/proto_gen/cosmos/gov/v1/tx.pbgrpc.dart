...
class MsgClient extends $grpc.Client {
  ...
  static final _$execLegacyContent = $grpc.ClientMethod<$0.MsgExecLegacyContent,
          $0.MsgExecLegacyContentResponse>(
      '/cosmos.gov.v1.Msg/ExecLegacyContent',
      ($0.MsgExecLegacyContent value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.MsgExecLegacyContentResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.MsgExecLegacyContentResponse> execLegacyContent(
      $0.MsgExecLegacyContent request,
      {$grpc.CallOptions? options}) {
...
abstract class MsgServiceBase extends $grpc.Service {
  ...
  MsgServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.MsgExecLegacyContent,
            $0.MsgExecLegacyContentResponse>(
        'ExecLegacyContent',
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.MsgExecLegacyContent.fromBuffer(value),
  ...
  $async.Future<$0.MsgExecLegacyContentResponse> execLegacyContent_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.MsgExecLegacyContent> request) async {
  ...
  $async.Future<$0.MsgExecLegacyContentResponse> execLegacyContent(
      $grpc.ServiceCall call, $0.MsgExecLegacyContent request);
