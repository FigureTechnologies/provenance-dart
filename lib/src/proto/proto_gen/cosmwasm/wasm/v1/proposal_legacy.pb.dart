...
class InstantiateContract2Proposal extends $pb.GeneratedMessage {
  ...
  factory InstantiateContract2Proposal.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InstantiateContract2Proposal.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'InstantiateContract2Proposal',
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'cosmwasm.wasm.v1'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'title')
    ...
    ..pc<$1.Coin>(8, _omitFieldNames ? '' : 'funds', $pb.PbFieldType.PM,
        subBuilder: $1.Coin.create)
    ..a<$core.List<$core.int>>(
        9, _omitFieldNames ? '' : 'salt', $pb.PbFieldType.OY)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  InstantiateContract2Proposal clone() =>
      InstantiateContract2Proposal()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  InstantiateContract2Proposal copyWith(
          void Function(InstantiateContract2Proposal) updates) =>
      super.copyWith(
              (message) => updates(message as InstantiateContract2Proposal))
          as InstantiateContract2Proposal;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static InstantiateContract2Proposal create() =>
      InstantiateContract2Proposal._();
  InstantiateContract2Proposal createEmptyInstance() => create();
  static $pb.PbList<InstantiateContract2Proposal> createRepeated() =>
      $pb.PbList<InstantiateContract2Proposal>();
  @$core.pragma('dart2js:noInline')
  static InstantiateContract2Proposal getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InstantiateContract2Proposal>(create);
