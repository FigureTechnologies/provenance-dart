...
class MsgClient extends $grpc.Client {
  ...
  static final _$moduleQuerySafe =
      $grpc.ClientMethod<$0.MsgModuleQuerySafe, $0.MsgModuleQuerySafeResponse>(
          '/ibc.applications.interchain_accounts.host.v1.Msg/ModuleQuerySafe',
          ($0.MsgModuleQuerySafe value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.MsgModuleQuerySafeResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.MsgModuleQuerySafeResponse> moduleQuerySafe(
      $0.MsgModuleQuerySafe request,
      {$grpc.CallOptions? options}) {
...
abstract class MsgServiceBase extends $grpc.Service {
  ...
  MsgServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.MsgModuleQuerySafe,
            $0.MsgModuleQuerySafeResponse>(
        'ModuleQuerySafe',
        moduleQuerySafe_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.MsgModuleQuerySafe.fromBuffer(value),
        ($0.MsgModuleQuerySafeResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$0.MsgModuleQuerySafeResponse> moduleQuerySafe_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.MsgModuleQuerySafe> request) async {
  ...
  $async.Future<$0.MsgModuleQuerySafeResponse> moduleQuerySafe(
      $grpc.ServiceCall call, $0.MsgModuleQuerySafe request);
}
