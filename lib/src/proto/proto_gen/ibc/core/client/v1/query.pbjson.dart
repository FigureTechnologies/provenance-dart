...
final $typed_data.Uint8List queryClientStateRequestDescriptor =
...
final $typed_data.Uint8List queryClientStatesRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List queryConsensusStatesRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List queryClientStatusRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List queryClientStatusResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List queryClientParamsRequestDescriptor =
    $convert.base64Decode('ChhRdWVyeUNsaWVudFBhcmFtc1JlcXVlc3Q=');
...
final $typed_data.Uint8List queryClientParamsResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List queryUpgradedClientStateRequestDescriptor =
    $convert.base64Decode('Ch9RdWVyeVVwZ3JhZGVkQ2xpZW50U3RhdGVSZXF1ZXN0');
...
final $typed_data.Uint8List queryUpgradedClientStateResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List queryUpgradedConsensusStateRequestDescriptor =
    $convert.base64Decode('CiJRdWVyeVVwZ3JhZGVkQ29uc2Vuc3VzU3RhdGVSZXF1ZXN0');
