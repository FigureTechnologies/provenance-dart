...
class BlockRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'tendermint.blocksync'),
...
class BlockResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$1.ExtendedCommit>(2, _omitFieldNames ? '' : 'extCommit',
        subBuilder: $1.ExtendedCommit.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $1.ExtendedCommit get extCommit => $_getN(1);
  @$pb.TagNumber(2)
  set extCommit($1.ExtendedCommit v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $1.ExtendedCommit ensureExtCommit() => $_ensure(1);
}
